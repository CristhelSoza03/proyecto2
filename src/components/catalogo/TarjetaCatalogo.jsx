...
const TarjetaCatalogo = ({ producto, categoriaNombre }) => {
  // Imagen 2: Variables de estado y lógica
  ...
  return (
    <>
      {/* Imagen 3: Estructura de la Tarjeta */}
      <Card 
      ...
      >
        {/* Imagen 4: Visualización de la imagen */}
        ...
        <Card.Body className="d-flex flex-column p-3">
          ...
          <div className="mt-auto pt-2">
            <h4 className="text-success fw-bold mb-0">
              C${parseFloat(producto.precio_producto).toFixed(1)}
            </h4>
          </div>
        </Card.Body>
      </Card>

      {/* Imagen 6: Modal de detalles */}
